...
--
-- Name: hashtags_name_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.hashtags_name_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: hashtags_name_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.hashtags_name_seq OWNED BY public.hashtags.name;
...
--
-- Name: hashtags name; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hashtags ALTER COLUMN name SET DEFAULT nextval('public.hashtags_name_seq'::regclass);
...
--
-- Name: hashtags_name_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.hashtags_name_seq', 1, false);
...
--
-- Name: post_hashtags post_hashtags_pk; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: post_hashtags post_hashtags_fk0; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: post_hashtags post_hashtags_fk1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.post_hashtags
    ADD CONSTRAINT post_hashtags_fk1 FOREIGN KEY (post_id) REFERENCES public.posts(id);
...
ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_fk1 FOREIGN KEY (link_id) REFERENCES public.links(id);
